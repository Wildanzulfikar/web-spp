	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">SPP</span>
              ...
              <i class="align-middle" data-feather="credit-card"></i> <span class="align-middle">Data SPP</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="file"></i> <span class="align-middle">Transaksi Pembayaran</span>
            </a>
					</li>
					<?php
					}
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <i class="avatar img-fluid rounded me-1" data-feather="user"></i><span class="text-dark"><?php echo $_SESSION['user']['nama_petugas'];?> </span>
              				</a>
                ...
                <i class="align-middle" data-feather="settings"></i>
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                <i class="avatar img-fluid rounded me-1" data-feather="user"></i><span class="text-dark"><?php echo $_SESSION['user']['nama'];?> </span>
              				</a>
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="logout.php">Log out</a>
							</div>
